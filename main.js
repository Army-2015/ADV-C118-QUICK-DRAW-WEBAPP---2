...
random_object= Math.floor((Math.random()*quick_draw_data_set.length)+1)
element_of_array= quick_draw_data_set[random_object];

console.log(quick_draw_data_set[random_object]);

var sketch= quick_draw_data_set[random_object];

document.getElementById("name_of_sketch_to_be_drawn").innerHTML = 'Sketch to be drawn: ' + sketch;
...
function check_sketch(){
    timer_counter++;
    document.getElementById("time_limit_of_every_sketch").innerHTML= 'Timer:' + timer_counter;
